...
protected:
  //--------------------------Global containers-------------------------------
    ...
    QList<QString> functionList;     // List of image processing functions ... DO NOT CHANGE THE ORDER
    vector<int> processingList[4];   // Stores the list of processing functions in stack
 ...
 protected:
  //---------------------------Fuction protoypes------------------------------
    ...
    void paramWindowSet(int slidernum,QString Text,int lowerlimit,int upperlimit);
