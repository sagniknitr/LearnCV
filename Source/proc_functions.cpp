...
Mat ImageProc::threshBinary(Mat src,int thresh)  // Input can be in BGR or Grayscale. Output is binary image
{
   Mat temp,dst;
   temp = src.clone();
   if(temp.channels() == 3)
        cvtColor(temp,temp,CV_BGR2GRAY);
   threshold(temp,dst,thresh,255,CV_THRESH_BINARY);
   return dst;
}
Mat ImageProc::threshAuto(Mat src)              // Input can be in BGR or Grayscal. Output is binary image
{
    Mat temp,dst;
    temp = src.clone();                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
    if(temp.channels() == 3)
        cvtColor(temp,temp,CV_BGR2GRAY);
    threshold(temp,dst,100,255,CV_THRESH_OTSU);
    return dst;
}

Mat ImageProc::cartesianRotate(Mat src,int method)     // Input can be 0 , positive or negative integers
{
    Mat temp,rotated;
    temp = src.clone();
    if (method <0)
            transpose(temp, temp);
    rotated = Mat(temp.rows, temp.cols, CV_MAKETYPE(CV_8U, temp.channels()));
    flip(temp, rotated, 1);
    if (method >0)
...
Mat ImageProc::mirrorImage(Mat src,int method)        // Input can be 0 or non zero
{
    ...
    mirrored = image.clone();//Mat(image.rows, image.cols, CV_MAKETYPE(CV_8U, image.channels()));
    if(method == 0)
...
Mat ImageProc::doGaussianBlur(Mat src,int xsize , int ysize ,int sigmaX,int sigmaY)
{
    Mat temp,blurred;
    temp = src.clone();
    if(ysize > (temp.rows-2))
...
Mat ImageProc::threshInRange(Mat src, int low1,int low2,int low3,int high1,int high2,int high3)
{
    Mat temp,inrange;
    temp = src.clone();
    if(temp.channels() == 1)
...
{
    Mat temp = src.clone();
    Mat erodingelement = getStructuringElement(MORPH_RECT,Size(dilatex,dilatey));
...
/*Mat ImageProc::detecthands(Mat src)
{
    ...
    //String face_cascade_name = "D:/Local/haarcascade/haarcascade_frontalface_alt2.xml";
    ...
    hand_cascade.load( hand_cascade_name );
        ...
        //hand_cascade.detectMultiScale( image_gray, hands, 1.1, 2, 0|CV_HAAR_SCALE_IMAGE, Size(30, 30),Size(400,400) );
    ...
    //	int hmax,hmin,smax,smin,
        ...
        {
            Point center(hands[i].x + hands[i].width/2, hands[i].y + hands[i].height*4/5);
            ...
            circle(image,center,2,Scalar(255,0,255),CV_FILLED);
        }
